...
#'
#' A random phylo object created by using the function \code{\link[ape]{rtree}}
#'
...
#'
#' This data provides the differential abundance information of clusters in the AML-sim data
#'
...
#'
#' A hclust object which records the hierarchical structure of the cells in the AML-sim data.
#'
