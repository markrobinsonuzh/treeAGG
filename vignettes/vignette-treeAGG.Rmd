...
The tree we use here is the hierarchical structure of cell clusters, obtained by hierarchical clustering of the individual clusters. It's a *hclust* object, provided as part of the **treeAGG** package. 
...
To use **treeAGG**, we need to transform the *hclust* object into a *phylo* object, using the *as.phylo* function from the **ape** package.
