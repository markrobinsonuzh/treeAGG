...
numeric value are the fold change of corresponding nodes. Each leaf node has a
...
the fixed branch. As a pair of branches is required in simulation, the other
